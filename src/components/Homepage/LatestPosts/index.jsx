        ...
        <div className="latest-posts">
            <div className="box">
                ...
                <div className="box-content">
                    Sniper isnt overpowered. Sniper has some of the lowest damage outputs in the game. 50 damage per
                    shot is terrible, especially with the fire rate. Compared to heavy, who has 400+ DPS!..{' '}
            ...
            <div className="box">
                ...
                <div className="box-content">
                    It'll still be long enough that it cannot be spammed. But will increase usefulness of the watch by
                    not..{' '}
                    <a href="#readmore" className="read-more" title="Read More">
                        Read More
                    </a>
